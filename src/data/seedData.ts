...
export const INITIAL_INTERVENTIONS: UnifiedIntervention[] = [
  // === LOTE TOMATE SALADETE (batch-tom-088 • Invernadero 01) ===
  {
    ...
    timestamp: '2026-07-15T08:00:00Z',
    type: 'manejo',
    title: 'Plantio & Transplante em Bancada NFT',
    productOrAction: '4.000 mudas sadias de Tomate Saladete San Marzano (Vivero Yguazú #SEM-892)',
    dosage: 'Espaçamento 25cm entre plantas',
    operatorName: 'Mateo González',
    operatorRole: 'Técnico de Campo',
    severity: 'normal',
    notes: 'Mudas com 4 folhas definitivas e excelente enraizamento. Bancadas previamente sanitizadas com ácido peracético.',
  ...
  },
  {
    ...
    type: 'nutricao',
    title: 'Fertirrigação Nutritiva Vegetativa',
    productOrAction: 'Fórmula N-P-K 15-05-30 + Quelato de Ferro EDDHA + Sulfato de Magnésio',
    dosage: '1.2 g/Litro de calda nutritiva',
    gracePeriodDays: 0,
    ph: 5.95,
    ec: 1.85,
    temperature: 23.8,
    ...
    operatorRole: 'Engenheiro Agrônomo',
    severity: 'normal',
    notes: 'Início da fase vegetativa rápida. Condutividade elétrica ajustada para desenvolvimento radicular.',
  ...
  },
  {
    ...
    type: 'manejo',
    title: 'Desbrota Manual & Amarrio em Fio Tutor',
    productOrAction: 'Retirada de brotos axilares e condução em haste única',
    dosage: '100% das 4.000 plantas tutoradas',
    operatorName: 'Juan Pérez',
    operatorRole: 'Operador de Estufa',
    severity: 'normal',
    notes: 'Desbrota realizada antes do meio-dia para cicatrização rápida ao sol.',
  ...
  },
  {
    ...
    type: 'nutricao',
    title: 'Aplicação Nutricional de Floração e Pegamento',
    productOrAction: 'Nitrato de Cálcio YaraLiva Calcinit + Ácido Bórico',
    dosage: '1.5 g/L Cálcio + 0.3 mg/L Boro',
    gracePeriodDays: 0,
    ph: 6.05,
    ec: 2.20,
    temperature: 25.1,
    ...
    operatorRole: 'Engenheiro Agrônomo',
    severity: 'normal',
    notes: 'Prevenção de podridão apical (fundo preto) e estímulo ao florescimento uniforme da 2ª florada.',
  ...
  },
  {
    ...
    type: 'fitossanidade',
    title: 'Controle Biológico Preventivo de Raiz e Folhas',
    productOrAction: 'Bacillus subtilis + Trichoderma harzianum (Bioinsumo Certificado SENAVE)',
    dosage: '2 mL/Litro via circulação contínua',
    gracePeriodDays: 0,
    ph: 6.10,
    ec: 2.15,
    operatorName: 'Juan Pérez',
    operatorRole: 'Operador de Estufa',
    severity: 'normal',
    notes: 'Proteção fúngica biológica. Carência zero (0 dias). Totalmente seguro para colheita.',
  ...
  },
  {
    ...
    type: 'fitossanidade',
    title: 'Inspeção Fitossanitária Atestada por IA Don Mateo',
    productOrAction: 'Amostragem em 60 pontos foliares e inspeção de ponteiros',
    operatorName: 'Mateo González',
    operatorRole: 'Técnico de Campo',
    severity: 'normal',
    notes: 'Laudo: Folhas limpas, vigor excelente, ausência de traça-do-tomateiro e míldio.',
  ...
  },
  {
    ...
    type: 'sensor_leitura',
    title: 'Calibração Instrumental & Leitura de Sensores',
    productOrAction: 'Aferição por condutivímetro e pHmetro de bancada digital',
    ph: 6.08,
    ec: 2.18,
    temperature: 24.5,
    humidity: 74,
    ...
    operatorRole: 'Técnico de Campo',
    severity: 'normal',
    notes: 'Solução nutritiva em equilíbrio perfeito. Leituras dos sensores IoT calibradas com precisão.',
  ...
  },
  {
    ...
    type: 'colheita',
    title: 'Colheita da 1ª Florada - Seleção Primeira Linha',
    productOrAction: 'Colheita manual em ponto salada (grau de maturação 3/5)',
    dosage: '45 caixas padrão (900 kg líquidos colhidos)',
    operatorName: 'Juan Pérez',
    operatorRole: 'Operador de Estufa',
    severity: 'normal',
    notes: 'Frutos com 5.2 °Brix, coloração uniforme, calibre 60-70mm. Rastreamento e etiquetas QR emitidos.',
  ...
  // === LOTE LOCOTE VERDE (batch-loc-042 • Invernadero 02) ===
  {
    ...
    timestamp: '2026-06-28T09:00:00Z',
    type: 'manejo',
    title: 'Transplante de Mudas Nathalie F1 em Substrato',
    productOrAction: '3.200 mudas em sacos de cultivo de fibra de coco e casca de arroz',
    dosage: '2 mudas por ponto de gotejador',
    operatorName: 'Mateo González',
    operatorRole: 'Técnico de Campo',
    severity: 'normal',
    notes: 'Substrato previamente saturado e lavado com condutividade de saída em 0.8 mS/cm.',
  ...
  },
  {
    ...
    type: 'nutricao',
    title: 'Fertirrigação de Enraizamento e Fósforo Assimilável',
    productOrAction: 'Fosfato Monopotássico MKP + Nitrato de Potássio + Magnésio',
    dosage: '1.0 g/L água de irrigação por pulso',
    gracePeriodDays: 0,
    ph: 6.25,
    ec: 1.65,
    temperature: 24.2,
    ...
    operatorRole: 'Engenheiro Agrônomo',
    severity: 'normal',
    notes: 'Excelente resposta radicular. Plantas estabelecidas em 12 dias.',
  ...
  },
  {
    ...
    type: 'manejo',
    title: 'Poda de Formação & Raleio da 1ª Flor (Flor Rei)',
    productOrAction: 'Remoção da primeira flor da bifurcação central para vigor de copa',
    dosage: '100% da estufa',
    operatorName: 'Juan Pérez',
    operatorRole: 'Operador de Estufa',
    severity: 'normal',
    notes: 'Estimula a planta a formar quatro hastes vigorosas antes da frutificação comercial.',
  ...
  },
  {
    ...
    type: 'nutricao',
    title: 'Nutrição Firmeza de Parede Celular & Antioxidação',
    productOrAction: 'Nitrato de Cálcio + Silicato de Potássio Foliar',
    dosage: '1.8 g/L via gotejamento + 1 mL/L foliar',
    gracePeriodDays: 0,
    ph: 6.30,
    ec: 1.95,
    temperature: 26.0,
    ...
    operatorRole: 'Engenheiro Agrônomo',
    severity: 'normal',
    notes: 'Parede celular espessa para garantir casca crocante e pós-colheita duradoura no transporte.',
  ...
  },
  {
    ...
    type: 'fitossanidade',
    title: 'Inspeção de Sanidade de Locote (Ácaro & Trips)',
    productOrAction: 'Amostragem em armadilhas adesivas amarelas e ponteiros',
    operatorName: 'Mateo González',
    operatorRole: 'Técnico de Campo',
    severity: 'normal',
    notes: 'Zero infestação de ácaro-branco. Lote em excelente estado sanitário sem necessidade de intervenção química.',
  ...
  },
  {
    ...
    type: 'sensor_leitura',
    title: 'Manejo de Clima & Ventilação das Cortinas',
    productOrAction: 'Abertura das cortinas zenitais e acionamento de nebulizador',
    ph: 6.22,
    ec: 2.05,
    temperature: 27.4,
    humidity: 72,
    ...
    operatorRole: 'Operador de Estufa',
    severity: 'normal',
    notes: 'Dissipação do pico térmico do meio-dia para evitar aborto de flores de locote.',
  ...
  },
  {
    ...
    type: 'colheita',
    title: 'Colheita Seletiva de Locote Verde Comercial',
    productOrAction: 'Corte com tesoura sanitizada preservando 1.5cm de pedúnculo',
    dosage: '38 caixas padrão (760 kg líquidos colhidos)',
    operatorName: 'Juan Pérez',
    operatorRole: 'Operador de Estufa',
    severity: 'normal',
    notes: 'Frutos pesados de 4 lóbulos, verde brilhante intenso. Destinados ao centro de distribuição.',
